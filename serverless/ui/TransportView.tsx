namespace UI {
    export const TransportView = ({ playing, reactor }: { playing: boolean, reactor: Reactor }) => {
        const playClass = `fa fa-3x ${playing ? "fa-stop-circle" : "fa-play-circle" } icon`;
        const togglePlayback = () => reactor.dispatch({ playing: !playing });

        return <div className="row">
            <div className="column">
                <h3>shout</h3>
            </div>
            <div className="column column-33 float-right">
                <div className="row">
                    <div className="column">
